 ...
 */
public class AutoAlignToCS extends SequentialCommandGroup {
  ...
  public AutoAlignToCS(CANDriveSubsystem drive, CoralStationSide cs) {
    this.drive = drive;
    boolean red  = DriverStation.getAlliance().orElse(DriverStation.Alliance.Blue)
                    == DriverStation.Alliance.Red;
    if (cs == CoralStationSide.LEFT) {
      basePose = (red) ? AutoHelpers.csLeftRed : AutoHelpers.csLeftBlue;
    } else {
      basePose = (red) ? AutoHelpers.csRightRed : AutoHelpers.csRightBlue;
    }
    ...
    DogLog.log("AutoAlign/Coral Station Side", cs.name());
    ...
    addCommands(
        ...
        new DriveToPose(drive, ()-> approachPose, ()-> AutoHelpers.kApproachLinearTolerance, ()-> AutoHelpers.kApproachAngularTolerance, true),
        new DriveToPose(drive, ()-> finalPose, ()-> AutoHelpers.kScoreLinearTolerance, ()-> AutoHelpers.kScoreAngularTolerance, true)
    );
  }
}
