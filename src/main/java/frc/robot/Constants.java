...
public final class Constants {
    ...
    public static class TrajectoryConstants {
        // --- FEEDFORWARD GAINS ---
        // TODO: Characterize your drivetrain to get these values.
        // The SysId tool in WPILib is the best way to do this.
        ...
        // --- PID GAINS ---
        // TODO: Tune this for velocity control in Motion Magic.
        // Start with kP and add kD if there is overshoot. kI is often not needed.
        public static final double kP = 2.4;
        public static final double kI = 0.0;
        public static final double kD = 0.1;
    
        // --- TRAJECTORY CONSTRAINTS ---
        // TODO: Tune these to match the robot's capabilities.
        public static final double CRUISE_MPS = 3.0;   // Max cruise velocity (m/s)
        public static final double ACCEL_MPS2 = 2.0;   // Max acceleration (m/s^2)
    }
    ...
    public static final class DriveConstants {
        ...
        public static final double DRIVE_GEARING = 8.45; // TODO: Verify your robot's gear ratio
        public static final double WHEEL_RADIUS_METERS = Units.inchesToMeters(3.0); // TODO: Measure your wheel radius
    ...
    public static final class LocalizationConstants {
        // TODO: Accurately measure the track width of your robot.
        public static final double TRACK_WIDTH_METERS = 0.6;
    }

    public static final class AutoAlignConstants {
        // Constants for the OLD PID-based AutoAlignCommand
        ...
        public static final double DESIRED_DISTANCE_METERS = 0.2; 
    }
    ...
    public static final class ElevatorConstants {
        ...
        // TODO: Tune these encoder values for the correct scoring heights
    ...
    public static final class VisionConstants {
         ...
         * TODO: You MUST update these values with your robot's measurements.
        ...
        public static final Transform3d LEFT_ROBOT_TO_CAMERA = 
            new Transform3d(
                new Translation3d(0.0, 0.0, 0.0), // TODO: (X, Y, Z) in meters
                new Rotation3d(0.0, 0.00, 0.0)      // TODO: (Roll, Pitch, Yaw) in radians
            );
        
        public static final Transform3d RIGHT_ROBOT_TO_CAMERA = 
            new Transform3d(
                new Translation3d(0.029, -0.05, 0.089), // TODO: Verify these measurements
        ...
        private static final Transform2d TAG_TO_LEFT_PEG = new Transform2d(new Translation2d(0, PEG_OFFSET_METERS), new Rotation2d());
        private static final Transform2d TAG_TO_RIGHT_PEG = new Transform2d(new Translation2d(0, -PEG_OFFSET_METERS), new Rotation2d());

        private static final Transform2d PEG_TO_ROBOT_GOAL = new Transform2d(
        ...
        public static final List<ScoringPose> ALL_SCORING_POSES = CORAL_SCORING_TAG_IDS.stream()
          .flatMap(tagId -> {
              ...
              Pose2d leftPegPose = tagPose.transformBy(TAG_TO_LEFT_PEG);
              Pose2d rightPegPose = tagPose.transformBy(TAG_TO_RIGHT_PEG);

              Pose2d leftGoalPose = leftPegPose.transformBy(PEG_TO_ROBOT_GOAL);
              Pose2d rightGoalPose = rightPegPose.transformBy(PEG_TO_ROBOT_GOAL);
        
              return Stream.of(
                  new ScoringPose(leftGoalPose, tagId, tagId + "_L2_LEFT", ScoringLevel.L2),
                  new ScoringPose(rightGoalPose, tagId, tagId + "_L2_RIGHT", ScoringLevel.L2),
                  new ScoringPose(leftGoalPose, tagId, tagId + "_L3_LEFT", ScoringLevel.L3),
                  new ScoringPose(rightGoalPose, tagId, tagId + "_L3_RIGHT", ScoringLevel.L3)
              );
