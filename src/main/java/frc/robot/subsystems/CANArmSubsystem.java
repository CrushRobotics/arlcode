...
public class CANArmSubsystem extends SubsystemBase {
    ...
    public CANArmSubsystem() {
        ...
        maxSim = new SparkMaxSim(armMotor, maxGearbox);
    }
    ...
    public void setPosition(double targetRotations) {
        ...
        pidController.setReference(targetRotations, ControlType.kMAXMotionPositionControl, ClosedLoopSlot.kSlot0, ArmConstants.kG);
    }
